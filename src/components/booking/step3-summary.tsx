...
import { Users, Calendar, Gamepad2, ToyBrick } from 'lucide-react';
...
export function Step3_Summary({ bookingDetails, basePrice, discountAmount, finalPrice, promotion }: Step3Props) {
  const { activityName, adults, children, games, addSoftPlay, softPlayChildren, date, time, contactDetails } = bookingDetails;
